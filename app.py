...
if __name__ == "__main__":
    ...
    if adjacent_blocks_df is not None:
        ...
        uploaded_file = st.file_uploader("Upload the PETS Application Data, after downloading the excel file from here: https://itportal.energysecurity.gov.uk/eng/fox/beis/PETS_EXTERNAL_PUBLICATION/main", type=['xlsx', 'xls'])
